        ...
        {student && (
          <div className="flex items-center gap-3">
            ...
            <div className="text-right pl-2 border-l border-slate-200 dark:border-slate-800">
              <div className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white max-w-[100px] sm:max-w-none truncate">{student.full_name}</div>
              <div className="text-[10px] sm:text-xs text-cyan-600 dark:text-cyan-400">Lớp {student.class_name || 'Chưa xếp lớp'}</div>
            </div>
